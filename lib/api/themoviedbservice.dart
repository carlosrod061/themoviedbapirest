...
import 'package:apirestmovies/api/movies.dart';
import 'dart:convert';
...
class TheMovieDBService {
  ...
  static Future<List<Movie>> getMovies(String category) async {
    var url =
        API_url + "/movie/" + category + "?api_key=" + API_key + "&language=es";
